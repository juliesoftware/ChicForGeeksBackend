    ...
    generate: async (): Promise<UserPool> => {
        const pool = new UserPool(generateName(PREFIX, "users"), {
            ...
            emailConfiguration: {
                ...
                sourceArn: "arn:aws:ses:us-east-1:292274522756:identity/help@nomadago.com"
            },
            emailVerificationSubject: "Verify your email on Nomadago",
            emailVerificationMessage: "Welcome to Nomadago!<br/><br/>To complete to the sign up process, please verify your email using the code below.<br/><br/>{####}",
            passwordPolicy: {
                minimumLength: 8,
            ...
            lambdaConfig: {
                postConfirmation: "arn:aws:lambda:us-east-1:292274522756:function:dev2-service-confirmation",
                preSignUp: "arn:aws:lambda:us-east-1:292274522756:function:dev2-service-confirmation-pre"
            }
        });
