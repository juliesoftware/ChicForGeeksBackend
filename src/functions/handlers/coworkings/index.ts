import {
    GQLCoworkingResult, GQLGetPaginatedCoworkingResponse, QueryToCoworkingsArgs,
} from "../../../../schemas";
...
export async function handler(
    event: AppSyncResolverEvent<QueryToCoworkingsArgs>
    ...
    console.log({
        message: "Coworking search has been invoked",
