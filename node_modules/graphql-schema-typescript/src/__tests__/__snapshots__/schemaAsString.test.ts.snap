...
exports[`schema as string should generate from local file if argument is a string 1`] = `
"/* tslint:disable */
/* eslint-disable */
...
exports[`schema as string should generate if schema is a valid graphql schema 1`] = `
"/* tslint:disable */
/* eslint-disable */
