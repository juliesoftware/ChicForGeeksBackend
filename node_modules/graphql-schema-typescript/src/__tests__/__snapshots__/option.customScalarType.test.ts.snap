...
exports[`customScalarType should generate known scalar type to its corresponding type 1`] = `
"/* tslint:disable */
/* eslint-disable */
...
exports[`customScalarType should generate unknown custom scalar type as \`any\` 1`] = `
"/* tslint:disable */
/* eslint-disable */
import { GraphQLResolveInfo, GraphQLScalarType } from 'graphql';
/**
