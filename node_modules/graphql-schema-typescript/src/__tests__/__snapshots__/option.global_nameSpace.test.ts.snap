...
exports[`global + namespace should have no conflict between global and namespace config 1`] = `
"/* tslint:disable */
/* eslint-disable */
...
exports[`global + namespace should wrap types in namespace if namespace is configured 1`] = `
"/* tslint:disable */
/* eslint-disable */
import { GraphQLResolveInfo, GraphQLScalarType } from 'graphql';
/**
