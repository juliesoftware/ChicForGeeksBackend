...
export interface GQLIProductTypeResolver<TParent = any> {
  (parent: TParent, context: string, info: GraphQLResolveInfo): 'ProductA' | 'ProductB' | Promise<'ProductA' | 'ProductB'>;
}
...
export interface RootQueryToUsersResolver<TParent = any, TResult = any> {
  (parent: TParent, args: RootQueryToUsersArgs, context: string, info: GraphQLResolveInfo): TResult;
}
...
export interface RootQueryToSearchResolver<TParent = any, TResult = any> {
  (parent: TParent, args: RootQueryToSearchArgs, context: string, info: GraphQLResolveInfo): TResult;
}
...
export interface RootMutationToCreateUserResolver<TParent = any, TResult = any> {
  (parent: TParent, args: RootMutationToCreateUserArgs, context: string, info: GraphQLResolveInfo): TResult;
}
...
export interface RootSubscriptionToUserLoggedInResolver<TParent = any, TResult = any> {
  resolve?: (parent: TParent, args: RootSubscriptionToUserLoggedInArgs, context: string, info: GraphQLResolveInfo) => TResult;
  subscribe: (parent: TParent, args: RootSubscriptionToUserLoggedInArgs, context: string, info: GraphQLResolveInfo) => AsyncIterator<TResult>;
}

export interface RootSubscriptionToSaleMadeResolver<TParent = any, TResult = any> {
  resolve?: (parent: TParent, args: {}, context: string, info: GraphQLResolveInfo) => TResult;
  subscribe: (parent: TParent, args: {}, context: string, info: GraphQLResolveInfo) => AsyncIterator<TResult>;
}

export interface GQLSearchResultTypeResolver<TParent = any> {
  (parent: TParent, context: string, info: GraphQLResolveInfo): 'User' | 'ProductA' | 'ProductB' | Promise<'User' | 'ProductA' | 'ProductB'>;
}
