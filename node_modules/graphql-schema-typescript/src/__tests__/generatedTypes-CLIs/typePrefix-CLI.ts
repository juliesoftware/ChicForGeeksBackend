 ...
 *                             *
 *******************************/
export interface MyPrefixIProduct {
  id: string;
  name: string;
  relatedProducts: Array<MyPrefixIProduct>;
}

/** Use this to resolve interface type IProduct */
export type MyPrefixPossibleIProductTypeNames = 'ProductA' | 'ProductB';

export interface MyPrefixIProductNameMap {
  IProduct: MyPrefixIProduct;
  ProductA: MyPrefixProductA;
  ProductB: MyPrefixProductB;
}

export interface MyPrefixProductA extends MyPrefixIProduct {
  id: string;
  name: string;
  relatedProducts: Array<MyPrefixIProduct>;
  ProductA1?: MyPrefixProductScalar;
  ProductA2: MyPrefixProductScalar;
  ProductA3?: Array<MyPrefixProductScalar | null>;
  ProductA4: Array<MyPrefixProductScalar | null>;
  ProductA5?: Array<MyPrefixProductScalar>;
  ProductA6: Array<MyPrefixProductScalar>;
}

export interface MyPrefixProductScalar {
...
export interface MyPrefixProductB extends MyPrefixIProduct {
  id: string;
  name: string;
  relatedProducts: Array<MyPrefixIProduct>;
  ProductB1?: MyPrefixProductListScalar;
  ProductB2: MyPrefixProductListScalar;
  ProductB3?: Array<MyPrefixProductListScalar | null>;
  ProductB4: Array<MyPrefixProductListScalar | null>;
  ProductB5?: Array<MyPrefixProductListScalar>;
  ProductB6: Array<MyPrefixProductListScalar>;
}

export interface MyPrefixProductListScalar {
...
export interface MyPrefixRootQuery {
  Users: Array<MyPrefixUser>;
  User?: MyPrefixUser;
  Products?: Array<MyPrefixIProduct>;
  Search?: MyPrefixSearchResult;
}

export interface MyPrefixRootMutation {
  createUser?: MyPrefixUser;
}

export interface MyPrefixRootSubscription {
  userLoggedIn: MyPrefixUser;
  saleMade: string;
}

export type MyPrefixDate = any;

export type MyPrefixSearchResult =
MyPrefixUser |
MyPrefixProductA |
MyPrefixProductB;

/** Use this to resolve union type SearchResult */
export type MyPrefixPossibleSearchResultTypeNames =
'User' |
'ProductA' |
'ProductB';

export interface MyPrefixSearchResultNameMap {
  SearchResult: MyPrefixSearchResult;
  User: MyPrefixUser;
  ProductA: MyPrefixProductA;
  ProductB: MyPrefixProductB;
}

export interface MyPrefixUser {
  firstName: string;
  lastName: string;
  ...
  username: string;
  email: string;
  role: MyPrefixUserRole;
  profilePicture?: string;
  activated: boolean;
}

export enum MyPrefixUserRole {
  SYS_ADMIN = 'SYS_ADMIN',
  MANAGER = 'MANAGER',
  CLERK = 'CLERK',
...
export interface MyPrefixUserFilter {
  username?: Array<string | null>;
}

export interface MyPrefixCreateUserInput {
  username: string;
  email: string;
  password: string;
  createdAt: MyPrefixDate;
}
 ...
 */
export interface MyPrefixResolver {
  IProduct?: {
    __resolveType: MyPrefixIProductTypeResolver
  };
  
  ProductA?: MyPrefixProductATypeResolver;
  ProductScalar?: MyPrefixProductScalarTypeResolver;
  ProductB?: MyPrefixProductBTypeResolver;
  ProductListScalar?: MyPrefixProductListScalarTypeResolver;
  RootQuery?: MyPrefixRootQueryTypeResolver;
  RootMutation?: MyPrefixRootMutationTypeResolver;
  RootSubscription?: MyPrefixRootSubscriptionTypeResolver;
...
export interface MyPrefixProductATypeResolver<TParent = any> {
...
export interface MyPrefixProductScalarTypeResolver<TParent = any> {
...
export interface MyPrefixProductBTypeResolver<TParent = any> {
...
export interface MyPrefixProductListScalarTypeResolver<TParent = any> {
...
export interface MyPrefixRootQueryTypeResolver<TParent = any> {
...
export interface MyPrefixRootSubscriptionTypeResolver<TParent = any> {
...
export interface MyPrefixUserTypeResolver<TParent = any> {
