...
export interface GQLRootQueryTypeResolver<TParent = undefined> {
...
export interface RootQueryToUsersResolver<TParent = undefined, TResult = any> {
  (parent: TParent, args: RootQueryToUsersArgs, context: any, info: GraphQLResolveInfo): TResult;
}

export interface RootQueryToUserResolver<TParent = undefined, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}

export interface RootQueryToProductsResolver<TParent = undefined, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface RootQueryToSearchResolver<TParent = undefined, TResult = any> {
  (parent: TParent, args: RootQueryToSearchArgs, context: any, info: GraphQLResolveInfo): TResult;
}

export interface GQLRootMutationTypeResolver<TParent = undefined> {
...
export interface RootMutationToCreateUserResolver<TParent = undefined, TResult = any> {
  (parent: TParent, args: RootMutationToCreateUserArgs, context: any, info: GraphQLResolveInfo): TResult;
}

export interface GQLRootSubscriptionTypeResolver<TParent = undefined> {
...
export interface RootSubscriptionToUserLoggedInResolver<TParent = undefined, TResult = any> {
...
export interface RootSubscriptionToSaleMadeResolver<TParent = undefined, TResult = any> {
