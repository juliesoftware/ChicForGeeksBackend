...
exports.getRulesPackages = void 0;
 ...
 * ```
 */
function getRulesPackages(opts) {
    if (!opts) {
        opts = {};
    }
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("aws:inspector/getRulesPackages:getRulesPackages", {}, opts);
}
exports.getRulesPackages = getRulesPackages;
