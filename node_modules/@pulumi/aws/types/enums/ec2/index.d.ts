export declare const InstancePlatform: {
    readonly LinuxUnix: "Linux/UNIX";
    readonly RedHatEnterpriseLinux: "Red Hat Enterprise Linux";
    readonly SuseLinux: "SUSE Linux";
    readonly Windows: "Windows";
    readonly WindowsWithSqlServer: "Windows with SQL Server";
    readonly WindowsWithSqlServerEnterprise: "Windows with SQL Server Enterprise";
    readonly WindowsWithSqlServerStandard: "Windows with SQL Server Standard";
    readonly WindowsWithSqlServerWeb: "Windows with SQL Server Web";
};
export declare type InstancePlatform = (typeof InstancePlatform)[keyof typeof InstancePlatform];
export declare const InstanceType: {
    ...
    readonly M5as_XLarge: "m5ad.xlarge";
     ...
     */
    readonly U_12tb1Metal: "u-12tb1.metal";
    /**
     * @deprecated This instancetype has been deprecated
     */
    readonly U_6tb1Metal: "u-6tb1.metal";
    /**
     * @deprecated This instancetype has been deprecated
     */
    readonly U_9tb1Metal: "u-9tb1.metal";
    /**
     * @deprecated This instancetype has been deprecated
     */
 ...
 */
export declare type PlacementStrategy = (typeof PlacementStrategy)[keyof typeof PlacementStrategy];
...
export declare type Tenancy = (typeof Tenancy)[keyof typeof Tenancy];
