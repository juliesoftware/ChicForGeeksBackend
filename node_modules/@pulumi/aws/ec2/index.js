...
__exportStar(require("./getIpamPreviewNextCidr"), exports);
...
__exportStar(require("./getVpcIamPool"), exports);
...
__exportStar(require("./subnetCidrReservation"), exports);
...
__exportStar(require("./vpcEndpointConnectionAccepter"), exports);
...
__exportStar(require("./vpcIpam"), exports);
__exportStar(require("./vpcIpamOrganizationAdminAccount"), exports);
__exportStar(require("./vpcIpamPool"), exports);
__exportStar(require("./vpcIpamPoolCidr"), exports);
__exportStar(require("./vpcIpamPoolCidrAllocation"), exports);
__exportStar(require("./vpcIpamPreviewNextCidr"), exports);
__exportStar(require("./vpcIpamScope"), exports);
__exportStar(require("./vpcIpv4CidrBlockAssociation"), exports);
__exportStar(require("./vpcIpv6CidrBlockAssociation"), exports);
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:ec2/subnetCidrReservation:SubnetCidrReservation":
                return new subnetCidrReservation_1.SubnetCidrReservation(name, undefined, { urn });
            ...
            case "aws:ec2/vpcEndpointConnectionAccepter:VpcEndpointConnectionAccepter":
                return new vpcEndpointConnectionAccepter_1.VpcEndpointConnectionAccepter(name, undefined, { urn });
            ...
            case "aws:ec2/vpcIpam:VpcIpam":
                return new vpcIpam_1.VpcIpam(name, undefined, { urn });
            case "aws:ec2/vpcIpamOrganizationAdminAccount:VpcIpamOrganizationAdminAccount":
                return new vpcIpamOrganizationAdminAccount_1.VpcIpamOrganizationAdminAccount(name, undefined, { urn });
            case "aws:ec2/vpcIpamPool:VpcIpamPool":
                return new vpcIpamPool_1.VpcIpamPool(name, undefined, { urn });
            case "aws:ec2/vpcIpamPoolCidr:VpcIpamPoolCidr":
                return new vpcIpamPoolCidr_1.VpcIpamPoolCidr(name, undefined, { urn });
            case "aws:ec2/vpcIpamPoolCidrAllocation:VpcIpamPoolCidrAllocation":
                return new vpcIpamPoolCidrAllocation_1.VpcIpamPoolCidrAllocation(name, undefined, { urn });
            case "aws:ec2/vpcIpamPreviewNextCidr:VpcIpamPreviewNextCidr":
                return new vpcIpamPreviewNextCidr_1.VpcIpamPreviewNextCidr(name, undefined, { urn });
            case "aws:ec2/vpcIpamScope:VpcIpamScope":
                return new vpcIpamScope_1.VpcIpamScope(name, undefined, { urn });
            ...
            case "aws:ec2/vpcIpv6CidrBlockAssociation:VpcIpv6CidrBlockAssociation":
                return new vpcIpv6CidrBlockAssociation_1.VpcIpv6CidrBlockAssociation(name, undefined, { urn });
